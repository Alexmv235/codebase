...
int main(int argc, char *argv[]) {
	...
	cin>>producto;
	cout<<endl<<"Digite el numero del dia mostrado en la lista: ";
	cin>>dia;
	cout<<endl<<"El dia "<<dias[dia]<<" se vendio la cantidad de "<<contenedor1.getPos(producto, dia)<<" del producto "<<productos[producto];
	cout<<endl;
	...
	cin>>producto;
	cout<<endl<<"Durante la semana se vendio la cantidad de "<<contenedor1.getProductoSemana(producto)<<" del producto "<<productos[producto];
	cout<<endl;
	...
	cin>>producto;
	cout<<endl<<"El dia "<<dias[contenedor1.diaMayorVentasSemana(producto)]<<" se hicieron mas ventas del producto "<<productos[producto];
	cout<<endl<<endl;
	...
	cin>>dia;
	cout<<endl<<"El dia "<<dias[dia]<<" se hicieron menos ventas del producto "<<productos[contenedor1.productoMenosVentasDia(dia)];
	cout<<endl;
